...
REM
REM Generated by Vivado on Wed Mar 12 11:01:19 +0000 2025
...
echo "xvlog --incr --relax -prj approx_mac8Bit_TB_vlog.prj"
call xvlog  --incr --relax -prj approx_mac8Bit_TB_vlog.prj -log xvlog.log
