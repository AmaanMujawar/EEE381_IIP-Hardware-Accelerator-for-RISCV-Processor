...
REM
REM Generated by Vivado on Wed Oct 23 15:53:54 +0100 2024
...
echo "xvlog --incr --relax -prj mac32Bit_TB_vlog.prj"
call xvlog  --incr --relax -prj mac32Bit_TB_vlog.prj -log xvlog.log
