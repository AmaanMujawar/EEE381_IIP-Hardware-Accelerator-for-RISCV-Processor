...
REM
REM Generated by Vivado on Wed Feb 19 16:35:49 +0000 2025
...
echo "xvlog --incr --relax -prj tb_dadda_PPAM_1_3_vlog.prj"
call xvlog  --incr --relax -prj tb_dadda_PPAM_1_3_vlog.prj -log xvlog.log
