    ...
    \begin{table}[ht]
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|c|c|c|c|c|} 
                ...
                \hline
                2 & Extenuating circumstances & L & H & Stay on top of work load \\
                \hline
                3 & Insufficient time for completion & L & H & Ensure regular progress is made and recorded \\
                \hline
                4 & Design Errors & M & H & Design reviews, regular meetings with supervisor \\
                \hline
                5 & Integration Failures & M & H & Version control, incremental testing \\
                \hline
                6 & Tool or Equipment Failures & L & M & Maintenance, backups \\
                \hline
                7 & Software Bugs & M & M & Code reviews, modular coding, testing \\
                \hline
            \end{tabular}
        }
    \end{table} 
